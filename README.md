...
This repository contains the worked sample app for the [Building a REST API with Grails and AngularJS 1.x](https://grails.apache.org/guides/grails-restapi-angularjs/4/guide/index.html) guide on the Apache Grails site.
